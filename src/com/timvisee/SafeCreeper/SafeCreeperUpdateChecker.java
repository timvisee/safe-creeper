...
public class SafeCreeperUpdateChecker extends Thread {
	public static SafeCreeper plugin;

	public SafeCreeperUpdateChecker(SafeCreeper instance) {
		plugin = instance;
	}
	...
	public String getLastVersion() {
		try {
		    ...
		    URL url = new URL("http://www.timvisee.com/projects/bukkit/safe-creeper/lastversion.php");
